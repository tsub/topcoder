...
public class EllysRoomAssignmentsDiv2 {
   public double getProbability(String[] ratings) {
   		int[] score = new int[ratings[][]];
   		int myscore = (int)ratings[0][0];
   }
   ...
   public static void main(String[] args) {
		if (args.length == 0) {
			...
			for (int i=0; i<args.length; ++i)
				EllysRoomAssignmentsDiv2Harness.run_test(Integer.valueOf(args[i]));
		}
	}
// END CUT HERE
}
...
class EllysRoomAssignmentsDiv2Harness {
 ...
 "194 372 951 991 947 1053 433 1017 1011 391 110 9 2", "30 245 788 830 747 2 3"};
			...
			return verifyCase(casenum__, expected__, new EllysRoomAssignmentsDiv2().getProbability(ratings));
		}
		case 1: {
