...
public class EllysNewNickname {
   public int getLength(String nickname) {
		...
		for(int i = 0; i < nickname.length(); i++){
			if((nickname.charAt(i) == 'a') || (nickname.charAt(i) == 'i') || (nickname.charAt(i) == 'u') || (nickname.charAt(i) == 'e') || (nickname.charAt(i) == 'o') || (nickname.charAt(i) == 'y')){
				vowel++;
			}else{vowel = 0;}
			if(vowel < 2){
				count++;
...
class EllysNewNicknameHarness {
	...
	static int runTestCase(int casenum__) {
		...
		case 0: {
			...
			return verifyCase(casenum__, expected__, new EllysNewNickname().getLength(nickname));
		}
		case 1: {
